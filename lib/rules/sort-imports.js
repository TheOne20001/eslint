...
module.exports = {
    ...
    create(context) {
        ...
        const configuration = context.options[0] || {},
            ...
            ignoreSyntaxSortOrder = configuration.ignoreSyntaxSortOrder || false,
        ...
        return {
            ImportDeclaration(node) {
                if (previousDeclaration) {
                    ...
                    if (!ignoreSyntaxSortOrder && (currentMemberSyntaxGroupIndex !== previousMemberSyntaxGroupIndex)) {
